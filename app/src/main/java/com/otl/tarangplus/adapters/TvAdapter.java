...
public class TvAdapter extends RecyclerView.Adapter {
    ...
    public TvAdapter(Activity context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        TvItemViewHolder viewHolder = (TvItemViewHolder) holder;
...
//                }
            ...
            viewHolder.parentPanel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (currentFragment != null && currentFragment instanceof LiveTvDetailsFragment) {
                        ...
                        analyticsProvider.userClickOnLiveTvNetCore();
    ...
    private TvItemViewHolder setUpSizeTwoItems(View view, int spanCount) {
        ...
        TvItemViewHolder holder = new TvItemViewHolder(view);
