...
public class SearchAdapter extends RecyclerView.Adapter {
    ...
    public SearchAdapter(Activity activity, List<Item> items) {
        this.mContext = activity;
        this.mListItems = items;
    }

    public void updateSearchItems(List<Item> items) {
...
//                    Picasso.get().load(R.drawable.live_rec).into(mSearchItemViewHolder.premium);
    ...
    class SearchItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public SearchItemViewHolder(final View itemView) {
            ...
            mParentItem.setOnClickListener(view -> {
                ...
                if (listener != null) {
                    listener.onClickSearchItem((Item) itemView.getTag());
                }
            });
        }
