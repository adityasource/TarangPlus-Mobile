...
public class TvListItemAdapter extends RecyclerView.Adapter {
    ...
    public TvListItemAdapter(Activity context) {
        this.context = context;
        itemList = new ArrayList<>();
    }

    public void setTvItems(List<Item> items) {
        itemList = items;
        notifyDataSetChanged();
    }

    public void appendSetTvItems(List<Item> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.t_16_9_small_meta, parent, false);
//        return setUpSizeTwoItems(view, 2);
        TvAdapter.TvItemViewHolder holder = new TvAdapter.TvItemViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        TvAdapter.TvItemViewHolder viewHolder = (TvAdapter.TvItemViewHolder) holder;
    ...
    private TvAdapter.TvItemViewHolder setUpSizeTwoItems(View view, int spanCount) {
